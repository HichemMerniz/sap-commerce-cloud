import {
  SMART_EDIT_FEATURE,
  SmartEditRootModule
} from "./chunk-VU6SGFHQ.js";
import {
  CART_QUICK_ORDER_FEATURE,
  QuickOrderRootModule
} from "./chunk-76ARZZ3X.js";
import {
  CHECKOUT_FEATURE,
  CheckoutRootModule
} from "./chunk-SHUPH6LA.js";
import {
  ORDER_FEATURE,
  OrderRootModule
} from "./chunk-KOYJT3XI.js";
import {
...
_UserFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [USER_ACCOUNT_FEATURE]: {
        module: () => import("./chunk-27MVUMZH.js").then((m) => m.UserAccountModule)
      }
    }
  }),
  provideConfig({
  ...
  provideConfig({
    featureModules: {
      [USER_PROFILE_FEATURE]: {
        module: () => import("./chunk-ZFLWCGAZ.js").then((m) => m.UserProfileModule)
      }
    }
  }),
  provideConfig({
...
_CartBaseFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CART_BASE_FEATURE]: {
        module: () => import("./chunk-DSRSJQSL.js").then((m) => m.CartBaseModule)
      }
    }
  }),
  provideConfig({
    featureModules: {
      [MINI_CART_FEATURE]: {
        module: () => import("./chunk-7KZJILX7.js").then((m) => m.MiniCartModule)
      }
    }
  }),
  provideConfig({
    featureModules: {
      [ADD_TO_CART_FEATURE]: {
        module: () => import("./chunk-6BA5WULK.js").then((m) => m.AddToCartModule)
      }
    }
  }),
  provideConfig({
...
_CartSavedCartFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CART_SAVED_CART_FEATURE]: {
        module: () => import("./chunk-6YOWBJ5C.js").then((m) => m.SavedCartModule)
      }
    }
  }),
  provideConfig({
...
_WishListFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CART_WISH_LIST_FEATURE]: {
        module: () => import("./chunk-N2FDZGGH.js").then((m) => m.WishListModule)
      }
    }
  }),
  provideConfig({
    featureModules: {
      [ADD_TO_WISHLIST_FEATURE]: {
        module: () => import("./chunk-GAT3WO5W.js").then((m) => m.AddToWishListModule)
      }
    }
  }),
  provideConfig({
...
_CartQuickOrderFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CART_QUICK_ORDER_FEATURE]: {
        module: () => import("./chunk-3IBCPHAA.js").then((m) => m.QuickOrderModule)
      }
    }
  }),
  provideConfig({
...
_CartImportExportFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CART_IMPORT_EXPORT_FEATURE]: {
        module: () => import("./chunk-SNOF3QOS.js").then((m) => m.ImportExportModule)
      }
    }
  }),
  provideConfig({
...
_OrderFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [ORDER_FEATURE]: {
        module: () => import("./chunk-65KYPTJJ.js").then((m) => m.OrderModule)
      }
    }
  }),
  provideConfig({
...
_CheckoutFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [CHECKOUT_FEATURE]: {
        module: () => import("./chunk-LKRKEBDS.js").then((m) => m.CheckoutModule)
      }
    }
  }),
  provideConfig({
...
_PersonalizationFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [provideConfig({
  featureModules: {
    [PERSONALIZATION_FEATURE]: {
      module: () => import("./chunk-PDFTCL7X.js").then((m) => m.PersonalizationModule)
    }
  }
...
_StoreFinderFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [STORE_FINDER_FEATURE]: {
        module: () => import("./chunk-M34KVILE.js").then((m) => m.StoreFinderModule)
      }
    }
  }),
  provideConfig({
...
_AsmFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [ASM_FEATURE]: {
        module: () => import("./chunk-C7CQLAXG.js").then((m) => m.AsmModule)
      }
    }
  }),
  provideConfig({
...
_AsmCustomer360FeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [ASM_CUSTOMER_360_FEATURE]: {
        module: () => import("./chunk-LF32OFQT.js").then((m) => m.AsmCustomer360Module)
      }
    }
  }),
  provideConfig({
...
_SmartEditFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [SMART_EDIT_FEATURE]: {
        module: () => import("./chunk-IXUXJLAR.js").then((m) => m.SmartEditModule)
      }
    }
  }),
  provideConfig({
...
_ProductVariantsFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [PRODUCT_VARIANTS_FEATURE]: {
        module: () => import("./chunk-Z74CH3XR.js").then((m) => m.ProductVariantsModule)
      }
    }
  }),
  provideConfig({
...
_ProductImageZoomFeatureModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ providers: [
  provideConfig({
    featureModules: {
      [PRODUCT_IMAGE_ZOOM_FEATURE]: {
        module: () => import("./chunk-ZYXZJWAL.js").then((m) => m.ProductImageZoomModule)
      }
    }
  }),
  provideConfig({
